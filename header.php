			...
			<div class="row">
				<div class="col-md-5 logo text-left">
					<a class="navbar-brand" href="index.php">
						...
						<i class="fab fa-linoda"></i><strong>  Get.Review</strong></a>
				</div>
				<div class="col-md-5 top-forms text-center mt-lg-3 mt-md-1 mt-0">
					...
					<span  > 
						<a href="blogadmin/membership_signup.php">
							<i class="far fa-user"></i> <strong>Become An Expert</strong></a>
					</span>
					<span >
						<a href="#">
						<button type="button" class="btn btn-sm btn-outline-dark  review-button">Get A Review</button></a>
					</span>
				</div>
